...
const Home: React.FC = () => {
  return (
    <main className="h-screen w-screen overflow-hidden bg-sand text-charcoal flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-[40%] lg:w-[35%] h-full flex flex-col justify-between p-8 md:p-12 lg:p-16 border-r border-charcoal/5 relative z-10 bg-sand">
      ...
      <section className="w-full md:w-[60%] lg:w-[65%] h-full relative bg-charcoal">
        <SimpleCarousel />
